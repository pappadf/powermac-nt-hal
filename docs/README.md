...
| [`2026-09-15-the-boot-floppy.md`](2026-09-15-the-boot-floppy.md) | **A plan, not a result.** Moving everything this project adds off the user's CD and onto a boot floppy: the step-by-step boot, the ten measurements that say it is possible, the one that says it is blocked, what to build and in what order — and why `pe-loader` being the only NT-ROM-specific package decides how this extends to a 7500/8500 |
